...
#创建指定长度的list
def dgbbc():
    i =[{'消息页面': 665, '社区首页': 2356, '启动APP': 488, '帖子详情-回复按钮': 209, '帖子详情-返回按钮': 2376, '首页': 853, '社区-最新页签': 214, '帖子详情': 3463, '选择发帖类型': 40, '发帖界面-发布按钮': 94, '评论界面-回复': 514, '我的界面': 398, '帖子详情-分享按钮': 16, '分享帖子': 13, '社区-精华页签': 12, '用户设置': 4, '社区-全部页签': 36, '社区-热门页签': 3, 'sitePostEdit': 1, '选择标签': 12, '用户名片界面': 847, '请求数据时': 9645, '首页-推文': 159, '返回桌面': 774, '返回APP': 906, '社区-热门版块': 60, '版块页面-全部按钮': 207, '试管婴儿版块': 261, '版块页面-帖子': 229, '社区-文章': 811, '搜索页面': 128, '帖子编辑页面': 65, '个人中心-帖子': 111, '帖子详情-评论区点赞': 2, '版块页面-最新按钮': 320, '版块页面-精华按钮': 100, '帖子详情-评论区回复': 440, '社区-全部版块': 2, '全部版块': 5, '全部版块-版块按钮': 4, '妈妈日记版块': 13, '童梦母婴版块': 69, '版块页面-置顶贴': 3, '首页-专题': 71, '首页-悬浮按钮': 14, '喜报版块': 72, '社区-发帖按钮': 8, '帖子详情-评论按钮': 465, '帖子详情-收藏按钮': 9, '个人中心-我的粉丝': 3, '粉丝界面': 5, '个人中心-我的关注': 2, '关注界面': 4, '帖子详情-功能按钮': 6, '版块页面-热门按钮': 95, '弹出框提示': 57, '搜索结果': 292, '帖子详情-点赞按钮': 165, '社区-搜索按钮': 23, '版块页面-发贴按钮': 14, '设置界面': 29, '帖子详情-删除': 1, '社区-广告': 1, '反馈界面': 16, '社区服务版块': 1, '不孕不育版块': 1, '手机登录/注册': 25, '帖子详情-关注/取关按钮': 1, '账号登陆': 3, '用户协议': 1, '发帖界面-添加页签': 2, '首页-轮播图': 32}, {'消息页面': 642, '启动APP': 488, '社区首页': 2274, '帖子详情-回复按钮': 186, '评论界面-回复': 599, '选择发帖类型': 33, '帖子详情': 3185, '选择标签': 65, '发帖界面-发布按钮': 81, '首页': 903, '社区-最新页签': 203, '帖子详情-返回按钮': 2104, '我的界面': 408, 'sitePostEdit': 13, '帖子详情-分享按钮': 14, '分享帖子': 10, '反馈界面': 21, '社区-精华页签': 13, '社区-全部页签': 32, '评论界面-删除': 2, '首页-推文': 162, '帖子详情-收藏按钮': 24, '弹出框提示': 68, '社区-热门页签': 7, '返回APP': 811, '请求数据时': 8780, '搜索页面': 119, '用户名片界面': 715, '返回桌面': 694, '帖子详情-评论区回复': 256, '社区-热门版块': 52, '版块页面-全部按钮': 225, '试管婴儿版块': 218, '版块页面-帖子': 187, '社区-文章': 790, '首页-专题': 75, '童梦母婴版块': 19, '帖子编辑页面': 66, '个人中心-我的粉丝': 2, '粉丝界面': 2, '用户设置': 11, '设置界面': 34, '关于我们': 2, '修改头像': 1, '版块页面-发贴按钮': 10, '发帖界面-添加页签': 20, '个人中心-帖子': 117, '首页-悬浮按钮': 10, '喜报版块': 51, '版块页面-最新按钮': 244, '社区-发帖按钮': 1, '帖子详情-关注/取关按钮': 7, '帖子详情-功能按钮': 7, '帖子详情-评论按钮': 459, '版块页面-热门按钮': 86, '版块页面-精华按钮': 95, '搜索结果': 130, '社区-搜索按钮': 9, '帖子详情-点赞按钮': 150, '帖子详情-删除': 3, '评论界面-举报': 2, '举报界面': 2, '手机登录/注册': 34, '账号登陆': 3, '修改密码': 1, '妈妈日记版块': 6, '社区-全部版块': 9, '全部版块': 18, '全部版块-版块按钮': 9, '不孕不育版块': 11, '社区活动版块': 3, '医疗信息版块': 4, '社区服务版块': 2, '关注界面': 2, '个人中心-我的关注': 2, 'themeView': 4, '全部版块-返回按钮': 7, '更换邮箱': 1, '修改昵称': 2, '首页-轮播图': 25, '帖子详情-评论区点赞': 2, 'reportTimes': 1}, {'启动APP': 197, '社区首页': 1033, '消息页面': 244, '帖子详情-回复按钮': 84, '帖子详情-返回按钮': 714, '社区-最新页签': 84, '帖子详情': 1001, '选择发帖类型': 13, '选择标签': 42, '发帖界面-发布按钮': 39, '评论界面-回复': 115, '首页': 285, '帖子详情-分享按钮': 8, '分享帖子': 5, '我的界面': 150, 'sitePostEdit': 4, '请求数据时': 2514, '返回APP': 320, '社区-文章': 316, '返回桌面': 280, '首页-推文': 42, '弹出框提示': 31, '评论界面-删除': 4, '版块页面-最新按钮': 73, '版块页面-热门按钮': 26, '版块页面-精华按钮': 27, '版块页面-全部按钮': 66, '社区-全部页签': 15, '搜索页面': 31, '用户名片界面': 163, '帖子详情-功能按钮': 15, '举报界面': 2, '反馈界面': 6, '首页-专题': 16, '帖子详情-评论区回复': 145, '首页-悬浮按钮': 1, '喜报版块': 1, '社区-发帖按钮': 1, '帖子编辑页面': 31, '个人中心-帖子': 35, '社区-精华页签': 5, '社区-热门版块': 14, '试管婴儿版块': 58, '版块页面-帖子': 48, '个人中心-我的关注': 6, '关注界面': 15, '帖子详情-删除': 2, '帖子详情-评论按钮': 67, '帖子详情-点赞按钮': 31, '帖子详情-收藏按钮': 5, '设置界面': 13, '用户设置': 6, '修改密码': 1, '搜索结果': 76, '社区-搜索按钮': 7, '发帖界面-添加页签': 21, '社区-全部版块': 2, '手机登录/注册': 12, '版块页面-置顶贴': 2, '帖子详情-关注/取关按钮': 2, '账号登陆': 1, '全部版块-版块按钮': 1, '全部版块': 1, '全部版块-返回按钮': 1, '社区-广告': 1, '社区-热门页签': 2, '童梦母婴版块': 5, '版块页面-发贴按钮': 3, '首页-轮播图': 14, '妈妈日记版块': 2, '评论界面-举报': 1, 'reportTimes': 1}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}]
